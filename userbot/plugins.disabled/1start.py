...
async def get_id(_, message: Message):
    ...
    if message.reply_to_message:
        ...
        if rep.audio:
            ...
            file_id += f"**File Unique ID**: `{rep.audio.file_unique_id}`\n"
            file_id += "**File Type**: `audio`"

        elif rep.document:
            file_id = f"**File ID**: `{rep.document.file_id}`\n"
            file_id += f"**File Unique ID**: `{rep.document.file_unique_id}`\n"
            file_id += f"**File Type**: `{rep.document.mime_type}`"

        elif rep.photo:
            file_id = f"**File ID**: `{rep.photo.file_id}`\n"
            file_id += f"**File Unique ID**: `{rep.photo.file_unique_id}`\n"
            ...
            file_id += f"**File Unique ID**: `{rep.video.file_unique_id}`\n"
            file_id += "**File Type**: `video`"

        elif rep.animation:
            file_id = f"**File ID**: `{rep.animation.file_id}`\n"
            file_id += f"**File Unique ID**: `{rep.animation.file_unique_id}`\n"
            file_id += "**File Type**: `GIF`"

        elif rep.voice:
            file_id = f"**File ID**: `{rep.voice.file_id}`\n"
            file_id += f"**File Unique ID**: `{rep.voice.file_unique_id}`\n"
